  ...
  return (
    <section className="explanationSection">
      ...
      <div className="linkGuides">
            ...
            <li><p><span style={bold}>Step 2.</span> Click on any thumbnail to view and see what people have to say, and comment on the post or other comments!</p></li>
            <li><p><span style={bold}>Step 3.</span> Click the post button at the top to post an image, gif, mp4, or youtube video by following the Link instructions below or click the "Link Guide" button after logged in.</p></li>
        </ul>
      </div>
