  ...
  return (
    <section className="explanationSection">
        ...
        <div className="linkGuides">
            ...
            <li>
              <p><span style={bold}>Step 3.</span> Click the post button at the top to post an image, gif, mp4, or youtube video by following the instructions with the "Link Guide" button.
              </p>
            </li>
        ...
        //   <h3 style={color}>*Also available after login</h3>
        //   <ul className="landingList">
